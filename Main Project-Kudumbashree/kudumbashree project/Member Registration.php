	<?php
		...
		if( $_FILES['file']['name'] != "" )
		{
			...
			else
			{
				...
				$sql="insert into membereg(unitid,name,addrs,dob,age,phone,occupn,educn,uname,pass,status,photo)values($uniname,'$name','$addr','$dob',$age,'$phone','$occupation','$edn','$uname','$pass','$st','$file');";
